...
export default function HabitsDashboardPage() {
    ...
    return (<div style={{ padding: "var(--space-6)", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--space-6)" }}>
            ...
            <button className="btn btn-primary"><Plus size={18} /> Add Habit</button>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
            {habits.map((h, i) => (
                <div key={i} className="card" style={{ padding: "var(--space-4)", display: "flex", alignItems: "center", gap: "var(--space-4)", borderLeft: h.done ? "4px solid var(--color-success)" : "4px solid transparent" }}>
